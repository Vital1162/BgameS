...
import com.uet.oop.bomberman.Game.exceptions.BombermanException;
...
//	public static final int LIVES = 3;
	...
	public void start() {
		...
		getBackgroundmusicPlayer = new SoundPlayer(new File("E:\\re\\music\\02-Opening.wav"));
		{
			if (_running == true) getBackgroundmusicPlayer.play();
			if (_running == false) getBackgroundmusicPlayer.stop();
		}
