...
import com.uet.oop.bomberman.entities.ManyE;
import com.uet.oop.bomberman.entities.Player;
import com.uet.oop.bomberman.enemy.Balloom;
import com.uet.oop.bomberman.enemy.Doll;
import com.uet.oop.bomberman.enemy.Kondoria;
import com.uet.oop.bomberman.enemy.Minvo;
import com.uet.oop.bomberman.enemy.Oneal;
	...
	public void addLevelEntity(char c, int x, int y) {
		...
		switch(c) { // TODO: minimize this method
			...
			case 'f': 
				...
				break;
			case '*': 
				_board.addEntitie(pos, new ManyE(x, y,
						new GrassTile(x ,y, Sprite.grass), 
						new BrickTile(x ,y, Sprite.brick)) );
				break;
			case 'x': 
