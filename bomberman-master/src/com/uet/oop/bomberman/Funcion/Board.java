package com.uet.oop.bomberman.Funcion;

import com.uet.oop.bomberman.Map.FileLevel;
import com.uet.oop.bomberman.Map.Level;
import com.uet.oop.bomberman.entities.Entity;
import com.uet.oop.bomberman.entities.Mess;
import com.uet.oop.bomberman.entities.Bomb;
import com.uet.oop.bomberman.entities.Explosion;
...
public class Board implements IRender {
	...
	private List<Mess> _messages = new ArrayList<Mess>();
...
//		_lives = Game.LIVES;
	...
	public boolean detectNoEnemies() {
		int total = 0;
		for (int i = 0; i < _mobs.size(); i++) {
			if(_mobs.get(i) instanceof Bomber == false)
				++total;
		}
	...
	public void renderMessages(Graphics g) {
		...
		for (int i = 0; i < _messages.size(); i++) {
			mess = _messages.get(i);
			
			g.setFont(new Font(null, Font.BOLD, mess.getSize()));
			g.setColor(mess.getColor());
			g.drawString(mess.getMessage(), (int)mess.getX() - Screen.xOffset  * Game.SCALE, (int)mess.getY());
		}
	}
